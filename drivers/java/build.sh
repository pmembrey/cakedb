#compile class files
javac -classpath /usr/share/java/junit4.jar org/cakedb/drivers/java/Event.java org/cakedb/drivers/java/Driver.java org/cakedb/drivers/java/UnitTestDriver.java
#run unit test
